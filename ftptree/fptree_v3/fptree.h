...
void 		  build_fptree(struct node *, int *, int *, struct header_table *);
struct node * insert_node(struct node*, short value, struct header_table *htable, int counter);
...
struct header_table * create_header_table(struct header_table *, int *);
...
struct node * build_sub_tree(struct node *, struct header_table *, struct frequent_patterns *, int *, int*);
